...
.controller('day1Controller', function ($scope) {
    ...
    function part1(data) {
      ...
      var l,w,h = 0;
      var lw, wh, lh = 0;
      var surfaceArea, extra, totalWrapping = 0;
      ...
      for (var i = 0; i < data.length; i++) {
        ...
        surfaceArea = 2*lw + 2*wh + 2*lh + extra;
        totalWrapping += surfaceArea;
      }
      $scope.part1Output = totalWrapping;
    }
    ...
    function part2(data) {
      ...
      var l,w,h = 0;
      var lw, wh, lh = 0;
      var totalRibbon, ribbonLen, bow = 0;
      ...
      for (var i = 0; i < 1; i++) {
        ...
        console.log("remove largest", Math.max(l,w,h));
        var index = dimensions.find(Math.min(l,w,h));
        console.log("at index", index);
        dimensions.splice(dimensions[index], 1);
        console.log("dimensions", dimensions);
        ribbonLen = 2*dimensions[0] + 2*dimensions[1];
        console.log("ribbonLen", ribbonLen);

        bow = l*w*h;
        console.log("bow", bow);
        totalRibbon = totalRibbon + ribbonLen + bow;
      }
      $scope.part2Output = totalRibbon;
    }
