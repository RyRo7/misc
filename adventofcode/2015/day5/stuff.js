...
for (var i=0; i<data.length; i++) {
  ...
  // console.log("word ["+word+"] disallowed ["+disallowed+"] vowels ["+vowels+"] duplicates ["+duplicates+"]");

  if (!disallowed && vowels >= 3 && duplicates) {
    niceCount++
  }
}
console.log('How many strings are nice?', niceCount);
...
for (var i=0; i<data.length; i++) {
  ...
  console.log("word ["+word+"] duplicates ["+duplicates+"] repeated ["+repeated+"]");
  if (duplicates && repeated) {
    niceCount++
  }
}
console.log('How many strings are nice under the new rules?', niceCount);
